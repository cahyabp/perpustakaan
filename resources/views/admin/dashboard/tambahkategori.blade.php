...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full h-screen flex-grow p-6">
        ...
        <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
            role="alert">
            <span class="font-medium">Sukses!!</span> Kategori Berhasil Di Tambahkan
        </div>
        @endif
        <h1 class="text-3xl text-black pb-6">Tambah Kategori</h1>

        <form method="POST" action="{{ route('admincreateCategory') }}">
            @method('POST')
            @csrf
            <div class="mb-6">
                ...
                <input type="text" id="kategori_buku"
                    ...
                    placeholder="Kategori Buku" required name="nama_kategori">
            </div>
            <button type="submit"
