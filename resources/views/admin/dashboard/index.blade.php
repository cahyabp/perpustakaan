        ...
        <div class="flex flex-wrap">
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            ...
                            <p class="font-bold text-3xl">
                                {{ $totalBook }} <span class="text-green-500"><i class="fas fa-caret-up"></i></span></p>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-blue-600"><i class="fas fa-users fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h2 class="font-bold uppercase text-gray-600">Jumlah Pengguna</h2>
                            <p class="font-bold text-3xl">{{ $totalUser }} <span class="text-blue-500"><i
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            ...
                            <p class="font-bold text-3xl">{{ $totalPinjam }} <span class="text-yellow-600"><i
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-pink-600"><i class="fas fa-server fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
