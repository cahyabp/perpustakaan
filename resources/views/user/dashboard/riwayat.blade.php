    ...
    <main class="w-full h-screen flex-grow p-6 px-10">
        ...
        <div class="relative overflow-x-auto pt-2">
            <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-gray-100 dark:bg-gray-900">
                <button type="button" class="bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <table class="w-full text-sm text-left shadow-md rounded-lg rtl:text-right text-gray-500 dark:text-gray-400">
