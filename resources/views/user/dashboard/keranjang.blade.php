...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full h-screen flex-grow p-6 px-10">
        ...
        <div class="flex items-center justify-between flex-column flex-wrap pt-4 md:flex-row space-y-4 md:space-y-0 pb-4 bg-gray-100 dark:bg-gray-900">
            <button type="button" class="bg-yellow-400 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <div class="flex gap-4 py-2 px-3 rounded-md text-white">
                    <svg viewBox="0 0 24 24" width='24' height='24' fill="#ffffff" xmlns="http://www.w3.org/2000/svg" stroke="#b8b8b8">
