    ...
    <main class="w-full h-screen flex-grow p-6 px-10">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="/users/detailbuku">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Judul Buku</h5>
                </a>
                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Tanggal Post: 2023-06-25</p>
